...
export function getPool() {
  if (!pool) {
    ...
    // Configuration SSL pour Supabase et Production
    // En production sur Vercel/AWS, ou si l'URL indique Supabase/SSL,
    // on doit activer SSL avec rejectUnauthorized: false pour accepter les certificats auto-signés
