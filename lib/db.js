...
export function getPool() {
  if (!pool) {
    ...
    // FIX: On force rejectUnauthorized: false dans tous les cas où on a une URL de DB
    // Cela résout l'erreur "self-signed certificate in certificate chain" de manière fiable
    // pour Supabase, Neon, et Vercel Postgres
