...
export function getPool() {
  if (!pool) {
    ...
    // On active rejectUnauthorized: false si l'URL contient 'supabase' (co ou com)
    // ou si sslmode=require est présent, pour éviter l'erreur SELF_SIGNED_CERT_IN_CHAIN
