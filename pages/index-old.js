                ...
                <div className="row align-items-center">
                  <div className="col-12 col-sm-8 col-md-8 col-lg-6 ml-auto">
                    <div className="slider-text">
                      ...
                      <Link href="/formations" className="animated fadeInUp btn-two">
                ...
                <div className="row align-items-center">
                  <div className="col-12 col-sm-8 col-md-8 col-lg-6 ml-auto">
                    <div className="slider-text">
                      ...
                      <Link href="/devenir-formateur" className="animated fadeIn btn-two">
                ...
                <div className="row align-items-center">
                  <div className="col-12 col-sm-8 col-md-8 offset-md-1 col-lg-6 offset-xl-2 col-xl-5 mr-auto">
                    <div className="slider-text mob-align-left">
                      ...
                      <Link href="/formations?filter=promo" className="animated fadeIn btn-two">
                        VOIR LES PROMOS
                      </Link>
                    </div>
                  </div>
